        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaimedByStaffId = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_AspNetUsers_ClaimedByStaffId",
                        column: x => x.ClaimedByStaffId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Inventory", x => x.Book_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClaimAuditLog_Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClaimAuditLogs", x => x.ClaimAuditLog_Id);
                    table.ForeignKey(
                        name: "FK_ClaimAuditLogs_AspNetUsers_Staff_Id",
                        column: x => x.Staff_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClaimAuditLogs_Order_Order_Id",
                        column: x => x.Order_Id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClaimAuditLogs_Order_Id",
                table: "ClaimAuditLogs",
                column: "Order_Id");

            migrationBuilder.CreateIndex(
                name: "IX_ClaimAuditLogs_Staff_Id",
                table: "ClaimAuditLogs",
                column: "Staff_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Order_ClaimedByStaffId",
                table: "Order",
                column: "ClaimedByStaffId");
